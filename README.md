...
| File Name	| Format |	Issue Type (what file lacks) |	Issue Severity |	Count (number of violations) | Ally Score | Fixed Score|
|-----------|-------|--------------------------------|-----------------|-------------------------------|-------|-|
|docx_test001	|docx|	Alternative text|	Minimal		|1|	76| 100|
|docx_test002|	docx|	Alternative text	|Intermediate	|	2|	53| 100|
|docx_test003|	docx	|Alternative text	|Intermediate|		5|	53| 100|
|docx_test004 |	docx	|Alternative text + Heading	|Minimal	|	2|	76| 95|
|docx_test005	|docx|	Color contrast	|Minimal	|	1	|76| 80|
|docx_test006	|docx|	Color contrast	|Intermediate	|	2	|53| 63|
|docx_test007	|docx|	Color contrast	|Severe	|	22	|5| 23|
|docx_test008	|docx|	Decorative Image	|Minimal	|	1	|76| 100|
|docx_test009|	docx|	Proper heading|	Minimal	|	1|	99| 99|
|docx_test010	|docx|	Links have text to describe target|	None|		1	|100| 100|
|pdf_test001	|pdf	|None	|None	|0	|100| 100|
|pdf_test002|	pdf	|Language set|	Minimal	|1|	95	|100|
|pdf_test003|	pdf	|Links have text to describe target	|None|	1	|100| 100|
|pdf_test004	|pdf	|List format	|None	|1	|100	| 100|
|pdf_test005	|pdf	|Tables with headers	|Minimal	|1	|68	|	68|
|pdf_test006	|pdf |Tables with headers + Color contrast	|Minimal|	2	|98	| 98|
|pdf_test007|	pdf	|Tagging pdf	|Severe	|1|	7		| 7|
|pdf_test008	|pdf|	Alternative text|	Minimal	|1	|77	|		86|																	
|pdf_test009|	pdf	|Alternative text|	Intermediate	|2	|54		| 63|
|pdf_test010|	pdf|	Alternative text	|Intermediate	|5	|54	| 63|
|pdf_test011|	pdf	|Color contrast|	Severe	|22	|5	| 5|
|pptx_test001|	pptx	|None|	None|	0	|100	| 100|
|pptx_test002|	pptx	|Alternative text	|Minimal	|1	|84	|	95|																		
|pptx_test003	|pptx|	Alternative text|	Intermediate	|2	|53		| 86|
|pptx_test004|	pptx	|Color contrast|	Minimal|	2|	86	|	98|																	
|pptx_test005	|pptx	|Color contrast	|Intermediate|	7	|48| 76|
|pptx_test006|	pptx|	Color contrast	|Intermediate	|5|	53| 83|
|pptx_test007	|pptx	| Text on image|	None|	1|	100		|	100|	
|pptx_test008|	pptx|	Title slide	|None	|1	|100	| 100|																			
